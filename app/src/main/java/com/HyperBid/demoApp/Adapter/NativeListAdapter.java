...
import com.HyperBid.demoApp.NativeDemoRender;
import com.HyperBid.demoApp.NativeListHelper;
...
public class NativeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private AdViewHolder onCreateAdViewHolder(@NonNull ViewGroup viewGroup) {
        ...
        HBNativeAdView atNativeAdView = new HBNativeAdView(viewGroup.getContext());
    ...
    private void onBindAdViewHolder(AdViewHolder viewHolder, int position) {
        ...
        if (mNativeListHelper != null) {
            ...
            NativeAd nativeAd = mNativeListHelper.getAd(position);
            ...
            if (nativeAd != null && mOnNativeListCallback != null) {
                mOnNativeListCallback.onBindAdView(nativeAd, viewHolder.mHBNativeAdView, viewHolder.nativeDemoRender);
...
//        Log.i(TAG, "getItemViewType: data " + position);
    ...
    public static class AdViewHolder extends RecyclerView.ViewHolder {
        ...
        HBNativeAdView mHBNativeAdView;
        ...
        AdViewHolder(@NonNull View itemView) {
            ...
            mHBNativeAdView = (HBNativeAdView) itemView;
            mAdContainer = mHBNativeAdView.findViewById(R.id.ad_container);
...
//            notifyItemRemoved(position);
    ...
    public void onViewRecycled(@NonNull RecyclerView.ViewHolder holder) {
        ...
        if (mNativeListHelper != null && holder instanceof AdViewHolder) {
            mNativeListHelper.clearView(holder.getAdapterPosition(), ((AdViewHolder) holder).mHBNativeAdView);
        }
    }
    ...
    public interface OnNativeListCallback {
        HBNativeAdView onBindAdView(NativeAd nativeAd, HBNativeAdView atNativeAdView, HBNativeAdRenderer<? extends CustomNativeAd> atNativeAdRenderer);
